...
const PageTitle = ({ title }: Props) => {
  ...
  return (
    <View className="items-center flex-row pt-[18px] px-6 justify-center relative min-h-[44px]">
      <TouchableOpacity className="bg-white rounded-full border-[1.15px] border-secondary-main items-center justify-center h-12 w-12 absolute top-[18px] left-6" onPress={router.back}>
        <CaretLeftIcon />
      </TouchableOpacity>
