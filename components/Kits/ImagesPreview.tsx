  ...
  return (
    <View style={{ gap: 12, marginBottom: 12 }}>
      <View className="rounded-[18.75px] overflow-hidden relative">
        <TouchableOpacity className="h-[43.52px] w-[43.52px] rounded-full bg-white shadow absolute top-[18.35px] left-[18.35px] items-center justify-center z-[1]" onPress={() => router.back()}>
          <CaretLeftIcon />
        </TouchableOpacity>
