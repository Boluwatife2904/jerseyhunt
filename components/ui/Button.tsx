...
const Button = ({ text, variant = "primary", disabled = false }: Props) => {
    ...
    return (
        <TouchableOpacity disabled={disabled} className={`min-h-[70px] w-full items-center justify-center rounded-[100px] shadow ${buttonVariants[variant].body}`}>
